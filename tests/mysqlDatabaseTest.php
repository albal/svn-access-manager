...
/**
 * Functions for testing MySQL database
 *
 * @author Thomas Krieger
 * @copyright 2008-2018 Thomas Krieger <tom@svn-access-manager.org>
 *           
...
/*
 *
 * $LastChangedDate: 2018-02-16 17:26:19 +0100 (Fri, 16 Feb 2018) $
 * $LastChangedBy: kriegeth $
 *
 * $Id: databaseTest.php 944 2018-02-16 16:26:19Z kriegeth $
 *
 */
/**
 * class to test mysql database functions
 */
final class MyMysqlDatabaseTest extends PHPUnit_Extensions_Database_TestCase {
    /**
    ...
    public function getConnection() {
        ...
        if ($this->conn === null) {
            try {
                $pdo = new PDO($GLOBALS['DB_MYSQL_DSN'], $GLOBALS['DB_MYSQL_USER'], $GLOBALS['DB_MYSQL_PASSWD']);
                $this->conn = $this->createDefaultDBConnection($pdo, $GLOBALS['DB_MYSQL_DBNAME']);
            }
    ...
    public function databaseLogin() {
        ...
        return db_connect_test($GLOBALS['DB_MYSQL_TYPE'], $GLOBALS['DB_MYSQL_HOST'], $GLOBALS['DB_MYSQL_USER'], $GLOBALS['DB_MYSQL_PASSWD'], $GLOBALS['DB_MYSQL_DBNAME']);
    ...
    public function testDatabaseUserFunctions() {
        ...
        $dbh = db_connect_test($GLOBALS['DB_MYSQL_TYPE'], $GLOBALS['DB_MYSQL_HOST'], $GLOBALS['DB_MYSQL_USER'], $GLOBALS['DB_MYSQL_PASSWD'], $GLOBALS['DB_MYSQL_DBNAME']);
    ...
    public function test_wrong_db_login() {
        ...
        $dbh = db_connect_test($GLOBALS['DB_MYSQL_TYPE'], $GLOBALS['DB_MYSQL_HOST'], $GLOBALS['DB_MYSQL_USER'], '4711', $GLOBALS['DB_MYSQL_DBNAME']);
