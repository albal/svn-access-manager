...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if( $button == _("Back" ) ) {
		...
		foreach( $tToAdd as $i => $userid ) {
			...
			$query							= "INSERT INTO ".$schema."svnusers (userid, name, givenname, password, passwordexpires, locked, emailaddress, admin, user_mode, created, created_user, password_modified, superadmin) ".
			                                  "     VALUES ('".$entry['userid']."', '".$entry['name']."', '".$entry['givenname']."', '$tPassword', 1, 0 ,'".$entry['emailaddress']."', 'n', '$tUserRight', now(), '".$_SESSION['svn_sessid']['username']."', '20000101000000', 0)";
