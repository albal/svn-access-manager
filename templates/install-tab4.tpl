...
<div class="form-group">
    <label class="col-sm-3 control-label" for="adminpw" data-toggle="tooltip" title="<?php print _("Enter the password for the admin user. It must be 14 characters at least and consinst of digits, lower case characters, upper case characters and special characters."); ?>"><?php print _("Admin password"); ?>:</label>
    <div class="col-sm-4">
        <input type="password" class="form-control" id="adminpw" name="fPassword" value="<?php print $tPassword; ?>" autocomplete="off" data-toggle="tooltip" title="<?php print _("Enter the password for the admin user. It must be 14 characters at least and consinst of digits, lower case characters, upper case characters and special characters.");?>" />
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" class="form-control" id="admingivenname" name="fGivenname" value="<?php print $tGivenname; ?>" data-toggle="tooltip" title="<?php print _("Administrator's given name");?>" />
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input type="text" class="form-control" id="adminname" name="fName" value="<?php print $tName; ?>" data-toggle="tooltip" title="<?php print _("Admin's name");?>" />
    </div>
</div>
<div class="form-group">
    <label class="col-sm-3 control-label" for="adminemail" data-toggle="tooltip" title="<?php print _("Enter the email address of the administrator."); ?>"><?php print _("SVN Access Manager Website URL"); ?>:</label>
    <div class="col-sm-4">
